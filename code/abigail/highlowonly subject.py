...
def subject_aware_split(dataset, train_ratio=0.7):
    # Group every sample index by its explicit string subject ID
    ...
    # Isolate subject groups entirely
    ...
    print(f"\nCross-Subject Split → Train Subjects: {len(train_subjects)} | Val Subjects: {len(val_subjects)}")
